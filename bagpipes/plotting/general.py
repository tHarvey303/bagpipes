...
latex_names = {"redshift": "z",
               ...
               "10": "\\mathrm{N}10",
               "sfr": "\\mathrm{SFR}",
               "sfr_10myr": "\\mathrm{SFR}_{10\\mathrm{Myr}}",
               "burstiness": "\\mathrm{SFR}_{10\\mathrm{Myr}}/\\mathrm{SFR}_{100\\mathrm{Myr}}",
               "mass_weighted_age": "\\mathrm{Age_{MW}}",
               "tform": "\\mathrm{t_{form}}",
               "tquench": "\\mathrm{t_{quench}}",
               "ssfr": "\\mathrm{log_{10}(sSFR",
               "ssfr_10myr": "\\mathrm{log_{10}(sSFR}_{10\\mathrm{Myr}}",
               "sig_exp": "\\Delta",
               "prob": "P",
               "mu": "\\mu",
               "sigma": "\\sigma",
...
latex_units = {"metallicity": "Z_{\\odot}",
               ...
               "sfr_10myr": "\\mathrm{M_\\odot\\ yr}^{-1}",
               "ssfr": "\\mathrm{yr}^{-1})}",
               "ssfr_10myr": "\\mathrm{yr}^{-1})}",
               "burstiness": "",
